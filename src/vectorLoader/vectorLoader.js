...
class VectorLoader extends olObject {
  constructor() {
    ...
    this.ajax.on('error', (e) => {
      dialog.show({
        content: 'Impossible de se connecter au serveur...<br/>Serveur indisponible<br/>Revenez utérieurement...',
        className: 'noServer'
      })
    });
    // Handle load
...
VectorLoader.prototype.loadGame = function(options, cback) {
  ...
  this.getCountryside(options, (c, landscape) => {
    ...
    // c = [997957.6389804836, 5155642.83789569];
